...
window.ZplWebApp.translations = {
    en: {
        ...
        "qr_options_heading": "QR Output",
        "qr_size_label": "Size (px)",
        "qr_margin_label": "Margin",
        ...
        "qr_logo_label": "Center Image",
        "qr_logo_title": "Add a logo or image",
        "qr_logo_subtitle": "Optional. The image is centered inside the QR code.",
        "qr_logo_badge": "Optional",
        "qr_logo_empty": "No center image selected.",
        "qr_logo_selected": "Center image ready: {name}",
        "qr_logo_remove": "Remove",
        "qr_logo_invalid": "Please choose a PNG, JPG, WEBP, or SVG image.",
        "qr_logo_too_large": "Center image must be 2 MB or smaller.",
        "qr_download_png": "Download PNG",
        "qr_download_svg": "Download SVG",
        "qr_preview_kicker": "Preview",
        "qr_preview_heading": "Live QR Preview",
        "qr_preview_caption": "Preview updates automatically as content or options change.",
        "qr_empty_state": "Enter text or a URL to generate a QR code preview.",
        ...
        "qr_svg_downloaded": "SVG download started.",
        ...
        "pdf_editor_heading": "PDF Add & Sign",
        "pdf_editor_subtitle": "Add text, images, signatures, and practical overlays onto existing PDF pages without rewriting the original document content.",
        "pdf_editor_picker_title": "Choose one PDF",
        "pdf_editor_picker_subtitle": "Open a PDF and prepare pages for text, sign, and stamp overlays.",
        "pdf_editor_picker_badge": "Editor",
        "pdf_editor_picker_empty": "No file selected yet.",
        "pdf_editor_tools_kicker": "Workspace",
        "pdf_editor_tools_heading": "Overlay Setup",
        "pdf_editor_tool_text": "Text",
        "pdf_editor_tool_image": "Image",
        "pdf_editor_tool_signature": "Signature",
        "pdf_editor_tool_stamp": "Stamp",
        "pdf_editor_text_label": "Text Content",
        "pdf_editor_font_size": "Font Size",
        "pdf_editor_text_color": "Color",
        "pdf_editor_image_title": "Choose image or logo",
        "pdf_editor_image_subtitle": "Upload a PNG, JPG, or WEBP image and place it on the current page.",
        "pdf_editor_image_badge": "Image",
        "pdf_editor_image_empty": "No image selected yet.",
        "pdf_editor_image_scale": "Width (%)",
        "pdf_editor_hint_text": "Choose a page, then click on the preview to place the current text overlay.",
        "pdf_editor_hint_image": "Choose a page, then click on the preview to place the current image overlay.",
        "pdf_editor_overlay_empty": "Placed overlays will appear here for the selected page.",
        "pdf_editor_overlay_text": "Text",
        "pdf_editor_overlay_image": "Image",
        "pdf_editor_remove_overlay": "Remove",
        "pdf_editor_text_required": "Enter text before placing it on the PDF.",
        "pdf_editor_image_required": "Upload an image before placing it on the PDF.",
        "pdf_editor_image_invalid": "Please choose a PNG, JPG, or WEBP image.",
        "pdf_editor_signature_note": "Visual Signature",
        "pdf_editor_signature_clear": "Clear",
        "pdf_editor_signature_upload_title": "Upload signature image",
        "pdf_editor_signature_upload_subtitle": "Optional. Use a signature image instead of drawing one.",
        "pdf_editor_signature_badge": "Signature",
        "pdf_editor_signature_empty": "Draw above or upload a signature image.",
        "pdf_editor_signature_scale": "Width (%)",
        "pdf_editor_signature_required": "Draw or upload a signature before placing it on the PDF.",
        "pdf_editor_signature_saved": "Signature ready. Click on the page preview to place it.",
        "pdf_editor_signature_invalid": "Please draw a signature or upload a PNG, JPG, or WEBP image.",
        "pdf_editor_doc_kicker": "Document",
        "pdf_editor_doc_heading": "Export Add-ons",
        "pdf_editor_stamp_type": "Stamp Type",
        "pdf_editor_stamp_mode_label": "Ready-made Stamp",
        "pdf_editor_stamp_mode_date": "Date Stamp",
        "pdf_editor_stamp_label": "Stamp Label",
        "pdf_editor_stamp_approved": "Approved",
        "pdf_editor_stamp_draft": "Draft",
        "pdf_editor_stamp_paid": "Paid",
        "pdf_editor_stamp_copy": "Copy",
        "pdf_editor_date_label": "Date",
        "pdf_editor_watermark_label": "Watermark",
        "pdf_editor_watermark_color": "Watermark Color",
        "pdf_editor_page_numbers_label": "Page Numbers",
        "pdf_editor_page_numbers_none": "None",
        "pdf_editor_page_numbers_top_left": "Top Left",
        "pdf_editor_page_numbers_top_right": "Top Right",
        "pdf_editor_page_numbers_bottom_left": "Bottom Left",
        "pdf_editor_page_numbers_bottom_right": "Bottom Right",
        "pdf_editor_page_numbers_bottom_center": "Bottom Center",
        "pdf_editor_hint_stamp": "Choose a page, then click on the preview to place the selected stamp or date.",
        "pdf_editor_stamp_required": "Choose a stamp label or date before placing it on the PDF.",
        "pdf_editor_export_success": "Updated PDF download started.",
        "pdf_editor_empty": "Upload a PDF to start placing add/sign overlays.",
        "pdf_editor_preview_hint": "Upload a PDF and choose a page to prepare add/sign overlays.",
        "pdf_editor_export": "Export Updated PDF",
